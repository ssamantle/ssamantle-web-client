...
export function InGamePage({
  ...
  function handleSubmitGuess(value: string) {
    if (!value.trim() || isLoading || gameOver) return;
  ...
  return (
      <>
          ...
          <GuessTable guesses={guesses} currentGuess={currentGuess} />
                  ...
                  {leaderboard.length > 0 ? (
                      <>
                              ...
                              <ol className="leaderboard-list leaderboard-list-upper">
                                  {upperLeaderboard.map((entry, index) => (
                                      ...
                                      >
                                          ...
                                          <span
                                              className={`leaderboard-name${index === 0 ? " leaderboard-name-top" : ""}`}
                                          >
                                              {entry.username}
                                          </span>
                          ...
                          {lowerLeaderboard.length > 0 && (
                              <ol
                                  className="leaderboard-list leaderboard-list-lower"
                                  start={4}
                              >
